...
final public class Module_math {
	...
	public static void init() {
		g_defaultMaxAbsoluteError=1.0E-12;
		g_defaultMaxRelativeError=1.0E-10;
	}
	...
	public static final double f_dpow(double ax, double am) {
			return (Native.exp((am*Native.log(Module_math.f_abs(ax))))*(((ax<0.0)&&((Module_math.f_floor(Module_math.f_abs(am))%2)==1))?(-1.0):1.0));
		}
